...
describe("Test for UserService", () => {
  test("1. Create a new user using the UserService", () => {
    const user = UserService.create(1, "Saul", "SaulD");
    expect(user.username).toBe("Saul");
    expect(user.name).toBe("SaulD");
  ...
  test("2. Get all user data in a list", () => {
    ...
    expect(userInfoInList[1]).toBe("Saul");
    expect(userInfoInList[2]).toBe("SaulD");
